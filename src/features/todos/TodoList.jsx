...
import { getTodos,addTodo,updateTodo,deleteTodo, todosUrlEndpoint as cacheKey,} from '../../api/todosApi'

const TodoList = () => {
    const [newTodo, setNewTodo] = useState('')

    const {isLoading,error,data:todos, mutate,}=useSWR(cacheKey,getTodos,{onSuccess: data => data.sort((a, b) => b.id - a.id)})
